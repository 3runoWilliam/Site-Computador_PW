    ...
    CommandLineRunner commandLineRunner(ComputadorRepository sapatoRepository, UsuarioRepository usuarioRepository, PasswordEncoder encoder){
        return args -> {
            List<Usuario> users = Stream.of(
                    new Usuario(1L, "Bruno", "Bruno", encoder.encode("1111"), "brunonegao@gmail.com", true),
					new Usuario(2L, "Taniro", "Taniro", encoder.encode("2222"), "tanirinhodograu@gmail.com", false),
                    new Usuario(3L, "Tobias", "Tobias", encoder.encode("3333"), "tobirutaododale@gmail.com", false)
